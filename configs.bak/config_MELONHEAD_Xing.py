...
sgolay_win=151
sgolay_smooth=5
allowed_vars=FLUORESCENCE_CHLA,CDOM,BETA_BACKSCATTERING470,MOLAR_DOXY,DOWNWELLING_PAR,TEMP,CNDC,PRES,TIME,LATITUDE,LONGITUDE,PROFILE_NUMBER
...
#accommodate units of W/m2: (assumed factor of 1000 out; 1000/4.7)
PAR_conversion=217
#-------------------------
